    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if(camera.useKeyboardInput)
            {
                ...
                camera.movementSpeedMultiplier = EditorGUILayout.FloatField("Speed Multiplier: ", camera.movementSpeedMultiplier);
            }
            ...
            if (camera.limitMap)
            {
                ...
                camera.terrainData = EditorGUILayout.ObjectField("Terrain Data: ", camera.terrainData, typeof(TerrainData)) as TerrainData;
            }
